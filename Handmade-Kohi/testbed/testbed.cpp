...
KINLINE b8 gameInitialize(game * gameInst){
    KDEBUG("gameInitialize() callsed!");
    return true;}

KINLINE b8 gameUpdate(game * gameInst, f32 deltaTime){
...
KINLINE b8 gameRender(game * gameInst, f32 deltaTime){return true;}
KINLINE void gameOnResize(game * gameInst, u32 width, u32 height){}
// Define the function to create a game
KINLINE b8 create_game(game* out_game) {
