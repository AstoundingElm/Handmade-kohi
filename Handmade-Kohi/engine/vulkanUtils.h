...
static inline const char * vulkanResultString(VkResult result, b8 getExtended){
      ...
      switch (result) {
        ...
        case VK_ERROR_INVALID_SHADER_NV: return !getExtended ? "VK_ERROR_INVALID_SHADER_NV" : "VK_ERROR_INVALID_SHADER_NV One or more shaders failed to compile or link. More details are reported back to the application via VK_EXT_debug_report if enabled.";
...
static inline b8 vulkanResultIsSuccess(VkResult result){
