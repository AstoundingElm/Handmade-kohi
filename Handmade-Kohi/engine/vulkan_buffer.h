...
KINLINE void vulkan_buffer_destroy(vulkanContext* context, vulkan_buffer* buffer) {
    if (buffer->memory) {
...
KINLINE void * vulkan_buffer_lock_memory(vulkanContext * context, vulkan_buffer * buffer, u64 offset, u64 size, u32 flags){
...
KINLINE void vulkan_buffer_unlock_memory(vulkanContext * context, vulkan_buffer * buffer){

    vkUnmapMemory(context->device.logicalDevice, buffer->memory);

};

KINLINE void vulkan_buffer_load_data(vulkanContext * context, vulkan_buffer * buffer, u64 offset, u64 size, u32 flags, const void * data){
...
KINLINE void vulkan_buffer_copy_to( vulkanContext* context,
    VkCommandPool pool,
    VkFence fence,
    VkQueue queue,
    VkBuffer source,
...
KINLINE b8 vulkan_buffer_resize(vulkanContext * context, u64 new_size, vulkan_buffer * buffer, VkQueue queue, VkCommandPool pool){
