...
KINLINE void inputShutdown(){

    inpInitialized = false;

};

KINLINE void inputUpdate(f64 deltaTime){
...
KINLINE KAPI b8 inputWasButtonDown(buttons button){
...
KINLINE KAPI b8 inputWasButtonUp(buttons button){
...
KINLINE KAPI void inputGetMousePosition(i32* x, i32* y){
...
KAPI static void inputGetPreviousMousePosition(i32* x, i32* y){
...
KINLINE void inputProcessMouseWheel(i8 z_delta){
