...
struct platformState;
 ...
 static inline b8 rendererBackendCreate(rendererBackendTypes type, struct platformState * platState, rendererBackend 
* outRendererBackend){
...
static inline void rendererBackendDestroy(rendererBackend * renderBackend){
