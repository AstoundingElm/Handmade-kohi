...
global_variable platform_state* platform_state_ptr;

KINLINE b8 platform_system_startup(
 ...
 *memory_requirement = sizeof(platform_state);
    ...
    platform_state_ptr = (platform_state *)state;
    ...
    xcb_void_cookie_t cookie = xcb_create_window(
        ...
        platform_state_ptr->screen->root_visual,
        event_mask,
        value_list);
    ...
    // Flush the stream
    i32 stream_result = xcb_flush(platform_state_ptr->connection);
    if (stream_result <= 0) {
...
KINLINE void platform_system_shutdown(void* plat_state) {
...
KINLINE keys translate_key_code(u32 x_keycode) {
    switch (x_keycode) {
        case XK_BackSpace:
...
KINLINE b8 platform_pump_messages() {
    if (platform_state_ptr) {
