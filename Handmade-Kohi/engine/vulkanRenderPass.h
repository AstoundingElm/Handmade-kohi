...
KINLINE void vulkanRenderPassCreate(vulkanContext * context, vulkanRenderpass * out_renderpass, f32 x, f32 y, 
...
KINLINE void vulkanRenderpassDestroy(vulkanContext * context, vulkanRenderpass * renderPass){
...
KINLINE void vulkanRenderPassBegin(vulkanCommandBuffer * command_buffer, vulkanRenderpass * renderpass, 
VkFramebuffer frameBuffer){
    ...
    kzeroMemory(clear_values, sizeof(VkClearValue) * 2);
...
KINLINE void vulkanRenderPassEnd(vulkanCommandBuffer * command_buffer, vulkanRenderpass * renderPass){
