...
void vulkan_pipeline_destroy(vulkanContext * context, vulkan_pipeline * pipeline){
...
void vulkan_pipeline_bind(vulkanCommandBuffer * command_buffer, VkPipelineBindPoint bind_point, vulkan_pipeline * pipeline){
