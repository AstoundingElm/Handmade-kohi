...
extern "C" {
#endif
//VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetPhysicalDeviceSurfaceCapabilitiesKHR(VkInstance instance, const char *pName);
...
//FN_vkCreateInstance MydefvkCreateInstance;

PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR MydefvkGetPhysicalDeviceSurfaceCapabilitiesKHR;
...
KINLINE void vulkanDeviceQuerySwapchainSupport(
  ...
  MydefvkGetPhysicalDeviceSurfaceCapabilitiesKHR = (PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR) vkGetInstanceProcAddr(NULL, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
