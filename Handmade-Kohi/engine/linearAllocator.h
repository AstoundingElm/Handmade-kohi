...
KINLINE KAPI void linear_allocator_create(u64 total_size, void * memory, linear_allocator * out_allocator){
...
KINLINE KAPI void linear_allocator_destroy( linear_allocator * allocator){
...
KINLINE KAPI void * linear_allocator_allocate(linear_allocator * allocator, u64 size ){
...
KINLINE KAPI void linear_allocator_free_all(linear_allocator * allocator){

     if (allocator && allocator->memory) {
        allocator->allocated = 0;
        kzeroMemory(allocator->memory, allocator->total_size);
    }
};