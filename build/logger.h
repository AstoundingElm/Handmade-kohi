...
static inline b8 initializeLogging(){
return true;

};

static inline void shutdownLogging(){


}
static inline void  platformConsoleWrite(const char * message, u8 colour){
    const char* colour_strings[] = {"0;41", "1;31", "1;33", "1;32", "1;34", "1;30"};
    printf("\033[%sm%s\033[0m", colour_strings[colour], message);
}
static inline void  platformConsoleWriteError(const char * message, u8 colour){

      const char* colour_strings[] = {"0;41", "1;31", "1;33", "1;32", "1;34", "1;30"};
    printf("\033[%sm%s\033[0m", colour_strings[colour], message);
}

static inline KAPI void logOutput(logLevel level, const char * message, ...){
